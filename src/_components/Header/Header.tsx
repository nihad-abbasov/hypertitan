          ...
          <div className="flex flex-row items-center text-sm">
            ...
            <div className="flex flex-row items-center text-sm mr-[10px]">
              ...
              >
                ...
                >
                  <g></g>
                  <path d="M12.461 5.57l-0.309 2.93h-2.342v8.5h-3.518v-8.5h-1.753v-2.93h1.753v-1.764c0-2.383 0.991-3.806 3.808-3.806h2.341v2.93h-1.465c-1.093 0-1.166 0.413-1.166 1.176v1.464h2.651z"></path>
                </svg>
              </Link>
              <Link
                target="_blank"
                href="https://www.instagram.com/hypertitan.baku/"
                passHref
